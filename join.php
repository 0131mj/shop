...
③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다.
		...
		<label for="agree_terms">회원가입 약관 내용에 동의합니다</a>
		<h3>개인정보 처리 방침</h3>
		<textarea class="join_agree">
...
로그인 기록: 3개월
		...
		<input type="checkbox" name="" id="agree_private">
		<label for="agree_private">개인정보 처리방침의 내용에 동의합니다</a>
		<br>
		<div class="center_btn_group">
			<a href="./register.php" class="center_btn button">개인회원<br>가입하기</a>
			<a href="./register.php" class="center_btn button">사업자회원<br>가입하기</a>
		</div>
		</article>
	</div>
